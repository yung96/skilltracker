...
export function MyAssignmentsPage() {
  ...
  return (
    <div className="space-y-6">
      {/* Заголовок */}
      <div>
        <h1 className="text-3xl font-bold text-gray-900 dark:text-white">Мои тесты</h1>
      ...
      <div className="space-y-4">
        {myAssignments.map((item) => (
          <Card key={item.assignment.id} className="p-6 dark:bg-gray-800 dark:border-gray-700">
      ...
      {myAssignments.length === 0 && (
        <div className="text-center py-12">
          ...
          <h3 className="text-lg font-medium text-gray-900 dark:text-white mb-1">Нет назначенных тестов</h3>
          <p className="text-gray-600 dark:text-gray-400">Вам еще не назначены тесты для прохождения</p>
        </div>
      )}
    </div>
  );
