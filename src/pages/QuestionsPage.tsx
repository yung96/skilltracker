  ...
  return (
    <div className="space-y-6">
      ...
      <div className="flex items-center justify-between">
        <div>
          <h1 className="text-3xl font-bold text-gray-900 dark:text-white">Банк вопросов</h1>
      ...
      <div className="space-y-4">
        {filteredQuestions.map((question) => (
          <Card key={question.id} className="p-6 dark:bg-gray-800 dark:border-gray-700">
            <div className="flex items-start justify-between gap-4">
              <div className="flex-1">
                ...
                {question.type === 'text' && question.text_answers && question.text_answers.length > 0 && (
                  <div className="space-y-2 mb-3">
                    <p className="text-sm font-medium text-gray-700 dark:text-gray-300">Правильные ответы:</p>
      ...
      {filteredQuestions.length === 0 && (
        <div className="text-center py-12">
          ...
          <h3 className="text-lg font-medium text-gray-900 dark:text-white mb-1">Вопросов не найдено</h3>
